...
corrections <- function(x) {
  x <- str_replace(x, "America$", "American")
  x <- str_replace(x, "Americans$", "American")
  ...
  x <- str_replace(x, "^Asia$", "Asian")
  x <- str_replace(x, "Austria\\.", "Austrian")
  x <- str_replace(x, "Belgium", "Belgian")
  x <- str_replace(x, "Czech Republic", "Czech")
  x <- str_replace(x, "Denmark", "Danish")
  x <- str_replace(x, "Egypt$", "Egyptian")
  ...
  x <- str_replace(x, "Portugal", "Portuguese")
  x <- str_replace(x, "Puerto Rico$", "Puerto Rican")
  x <- str_replace(x, "Russia$", "Russian")
  x <- str_replace(x, "Arabia$", "Arabian")
